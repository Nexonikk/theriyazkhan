  ...
  return (
    <div className="min-h-screen bg-[#FDFCF0] text-slate-900 selection:bg-blue-500/30 overflow-hidden">
      ...
      <motion.nav
        ...
        animate={{ opacity: 1, y: 0 }}
        className="fixed top-0 w-full bg-transparent backdrop-blur-md z-50 border-b border-white/10"
      >
            ...
            >
              <div className="flex flex-col items-start gap-4">
                <p className="text-gray-500 text-sm font-medium uppercase tracking-wider">
                  Trusted by leading EdTech & SaaS companies
                </p>
      ...
      <section
        id="certifications"
        className="relative py-20 px-6 bg-black border-t border-gray-800"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial="initial"
      ...
      <section
        id="contact"
        className="relative py-32 px-6 overflow-hidden bg-gradient-to-r from-black via-sky-400 to-black animate-gradient-xy"
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
        ...
        <Calendly />
            <motion.p
              variants={fadeInUp}
              className="text-lg text-gray-400 mb-12 mt-5"
            >
              Let&apos;s connect and explore how I can help you achieve your
              growth targets.
            </motion.p>
            ...
            >
              ...
              >
                <Mail className="mr-2 w-5 h-5" />
                <a href="mailto:khanriyaz.160621@gmail.com">Send Email</a>
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="group border-gray-700 text-gray-300 hover:bg-gray-800 hover:text-white border-2"
              >
